                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="register_edit.php" method="post">
                                    <input type="hidden" name="edit_id" value="<?php echo $row['costura_id']; ?>">
                                    <button type="submit" name="edit_btn" class="btn btn-success"> EDITAR</button>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="register_edit.php" method="post">
                                    <input type="hidden" name="edit_id" value="<?php echo $row['plano_unico_id']; ?>">
                                    <button type="submit" name="edit_btn" class="btn btn-success"> EDITAR</button>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="register_edit.php" method="post">
                                    <input type="hidden" name="edit_id" value="<?php echo $row['ferro_id']; ?>">
                                    <button type="submit" name="edit_btn" class="btn btn-success"> EDITAR</button>
                                </form>
                            </td>
                        </tr>
